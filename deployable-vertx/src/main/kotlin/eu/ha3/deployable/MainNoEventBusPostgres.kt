...
import eu.ha3.x.sff.system.postgres.PostgresRxDocSystem
...
fun main(args: Array<String>) {
    ...
    val verticles = listOf(WebVerticle(ReactiveDocStorage(SuspendedToRxDocSystem(PostgresRxDocSystem(db)))))
